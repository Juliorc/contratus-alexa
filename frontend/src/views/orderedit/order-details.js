...
<div class="scrollable main-row" id="main">
 <div class="meta-row">
  ...
  <span class="dim">Contrato #[[item.id]]</span>
 </div>
 <vaadin-form-layout id="form1">
  <vaadin-form-item id="vaadinFormItem">
   <label slot="label">Fecha Inicio</label>
   <vaadin-form-layout id="form2">
    <div class="date">
     <h3>[[item.startDate.day]]</h3>
     <span class="dim">[[item.startDate.weekday]]</span>
    </div>
   </vaadin-form-layout>
  </vaadin-form-item>
  <vaadin-form-item colspan="2">
   <label slot="label">Cliente</label>
   <h3>[[item.customer.fullName]]</h3>
  </vaadin-form-item>
  <vaadin-form-item>
   <label slot="label">Número de teléfono</label>
   <h3>[[item.customer.phoneNumber]]</h3>
  </vaadin-form-item>
 </vaadin-form-layout>
 <vaadin-form-layout id="form3">
  <vaadin-form-item id="vaadinFormItem">
   <label slot="label">Fecha Final</label>
   <vaadin-form-layout id="form2">
    <div class="date">
  ...
  <vaadin-form-layout id="form4" colspan="2">
   ...
   <vaadin-form-item id="history" label-position="top" hidden="[[review]]">
    <label slot="label">Historial</label>
...
<buttons-bar id="footer" no-scroll\$="[[noScroll]]">
 ...
 <vaadin-button slot="right" id="save" theme="primary success" hidden="[[!review]]">
  <iron-icon icon="vaadin:check" slot="suffix"></iron-icon> Crear contrato 
 </vaadin-button>
