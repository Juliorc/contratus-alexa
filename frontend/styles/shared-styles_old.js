...
$_documentContainer.innerHTML = `<dom-module id="alexa-app-layout-theme" theme-for="vaadin-app-layout">
  <template>
    <style>
      :host {
...
<dom-module id="alexa-login-theme" theme-for="vaadin-login-overlay-wrapper">
  <template>
    <style>
      [part="brand"] {
...
<dom-module id="alexa-crud-theme" theme-for="vaadin-crud">
  <template>
    <style>
      :host {
        height: 100%;
...
<!-- Themes for dialogs -->
<dom-module id="alexa-dialog-overlay-theme" theme-for="vaadin-dialog-overlay">
  <template>
    <style>
      :host([theme~="orders"]) {
...
<dom-module id="alexa-text-field-theme" theme-for="vaadin-text-field">
  <template>
    <style>
...
<dom-module id="alexa-grid-theme" theme-for="vaadin-grid">
  <template>
    <style>
      :host {
        width: 100%;
