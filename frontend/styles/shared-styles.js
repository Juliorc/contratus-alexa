...
<custom-style>
  <style>
    html {
      --lumo-body-text-color: hsla(306, 40%, 16%, 0.94);
      --lumo-primary-color: hsl(208, 86%, 31%);
      --lumo-primary-text-color: hsl(208, 86%, 31%);
      --lumo-error-text-color: hsl(3, 100%, 61%);
      --lumo-success-color: hsl(192, 100%, 44%);
      --lumo-success-text-color: hsl(192, 100%, 44%);
      --lumo-base-color: #fff;
    }
  </style>
</custom-style>
