package com.contratus.testbench;
...
import com.contratus.testbench.elements.components.OrderCardElement;
import com.contratus.testbench.elements.ui.OrderItemEditorElement;
import com.contratus.testbench.elements.ui.StorefrontViewElement;
import com.contratus.testbench.elements.ui.StorefrontViewElement.OrderEditorElement;
import com.contratus.testbench.elements.ui.UsersViewElement;
...
public class StorefrontViewIT extends AbstractIT<StorefrontViewElement> {
	...
	public void editOrder() {
		...
		editBtn.click();
		Assert.assertThat(getDriver().getCurrentUrl(), containsString(Constants.PAGE_STOREFRONT_EDIT));
