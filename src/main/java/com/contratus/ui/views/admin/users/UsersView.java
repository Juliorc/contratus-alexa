package com.contratus.ui.views.admin.users;

import static com.contratus.ui.utils.Constants.PAGE_USERS;
...
import com.contratus.backend.service.UserService;
...
@Secured(Role.ADMIN)
public class UsersView extends AbstractAlexaCrudView<User> {
