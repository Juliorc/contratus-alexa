...
import com.contratus.backend.data.entity.util.EntityUtil;
...
import com.contratus.app.HasLogger;
import com.contratus.backend.data.entity.Order;
import com.contratus.ui.MainView;
import com.contratus.ui.components.SearchBar;
import com.contratus.ui.utils.Constants;
import com.contratus.ui.views.EntityView;
import com.contratus.ui.views.orderedit.OrderDetails;
import com.contratus.ui.views.orderedit.OrderEditor;

@Tag("storefront-view")
@JsModule("./src/views/storefront/storefront-view.js")
@Route(value = Constants.PAGE_STOREFRONT, layout = MainView.class)
@RouteAlias(value = Constants.PAGE_STOREFRONT_EDIT, layout = MainView.class)
...
public class StorefrontView extends PolymerTemplate<TemplateModel>
	...
	public void setParameter(BeforeEvent event, @OptionalParameter Long orderId) {
		boolean editView = event.getLocation().getPath().contains(Constants.PAGE_STOREFRONT_EDIT);
		if (orderId != null) {
