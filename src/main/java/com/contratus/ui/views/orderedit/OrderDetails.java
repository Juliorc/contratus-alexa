 ...
 *
 */
package com.contratus.ui.views.orderedit;
...
import com.contratus.ui.events.CancelEvent;
import com.contratus.ui.events.SaveEvent;
import com.contratus.ui.utils.converters.CurrencyFormatter;
import com.contratus.ui.utils.converters.LocalDateTimeConverter;
import com.contratus.ui.utils.converters.LocalTimeConverter;
import com.contratus.ui.utils.converters.LongToStringConverter;
import com.contratus.ui.utils.converters.OrderStateConverter;
import com.contratus.ui.views.storefront.converters.StorefrontLocalDateConverter;
import com.contratus.ui.views.storefront.events.CommentEvent;
import com.contratus.ui.views.storefront.events.EditEvent;
...
public class OrderDetails extends PolymerTemplate<OrderDetails.Model> {
	...
	public interface Model extends TemplateModel {
		@Include({ "id", "startDate.day", "startDate.weekday", "startDate.date", "dueDate.day", "dueDate.weekday", "dueDate.date", "state", "pickupLocation.name",
		...
		@Encode(value = StorefrontLocalDateConverter.class, path = "startDate")
