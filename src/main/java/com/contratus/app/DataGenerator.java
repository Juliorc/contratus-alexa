...
import com.contratus.backend.data.entity.Customer;
import com.contratus.backend.data.entity.HistoryItem;
import com.contratus.backend.data.entity.Order;
import com.contratus.backend.data.entity.OrderItem;
import com.contratus.backend.data.entity.PickupLocation;
import com.contratus.backend.data.entity.Product;
import com.contratus.backend.data.entity.User;
import com.contratus.backend.repositories.OrderRepository;
import com.contratus.backend.repositories.PickupLocationRepository;
import com.contratus.backend.repositories.ProductRepository;
import com.contratus.backend.repositories.UserRepository;
...
public class DataGenerator implements HasLogger {
	...
	private User createBaker(UserRepository userRepository, PasswordEncoder passwordEncoder) {
		return userRepository.save(
				createUser("baker@contratus.com", "Heidi", "Carter", passwordEncoder.encode("baker"), Role.BAKER, false));
	}

	private User createBarista(UserRepository userRepository, PasswordEncoder passwordEncoder) {
		return userRepository.save(createUser("pedro@contratus.com", "Malin", "Castro",
				passwordEncoder.encode("pedro"), Role.BARISTA, true));
	}

	private User createAdmin(UserRepository userRepository, PasswordEncoder passwordEncoder) {
		return userRepository.save(
				createUser("admin@contratus.com", "Göran", "Rich", passwordEncoder.encode("admin"), Role.ADMIN, true));
	}

	private void createDeletableUsers(UserRepository userRepository, PasswordEncoder passwordEncoder) {
		userRepository.save(
				createUser("peter@contratus.com", "Peter", "Bush", passwordEncoder.encode("peter"), Role.BARISTA, false));
		userRepository
				.save(createUser("mary@contratus.com", "Mary", "Ocon", passwordEncoder.encode("mary"), Role.BAKER, true));
	}
