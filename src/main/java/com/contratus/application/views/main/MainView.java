package com.contratus.application.views.main;
...
import com.contratus.application.views.dashboard.DashboardView;
import com.contratus.application.views.masterdetail.MasterDetailView;
import com.contratus.application.views.form.FormView;
import com.contratus.application.views.cardlist.CardListView;
import com.contratus.application.views.contratus.ContratusView;
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logos/18.png", "Contratus logo"));
        logoLayout.add(new H1("Contratus"));
    ...
    private Component[] createMenuItems() {
        RouterLink[] links = new RouterLink[] {
            ...
            new RouterLink("Contratus", ContratusView.class)
        };
